...
[![Build Status](https://travis-ci.com/usgs/aqts-capture-discrete-loader.svg?branch=master)](https://travis-ci.com/usgs/aqts-capture-discrete-loader)
[![codecov](https://codecov.io/gh/usgs/aqts-capture-discrete-loader/branch/master/graph/badge.svg)](https://codecov.io/gh/usgs/aqts-capture-discrete-loader)

Loads discrete ground water levels from the transform database into the observation database for use by the observations service.
