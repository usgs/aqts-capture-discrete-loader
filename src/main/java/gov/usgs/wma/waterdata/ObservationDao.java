            ...
            int [] rowsInsertedCounts = jdbcTemplate.batchUpdate(
                    ...
                    new BatchPreparedStatementSetter() {
                        ...
                        public void setValues(PreparedStatement ps, int i) throws SQLException {
                            ...
                            ps.setString(8, discreteGroundWaterList.get(i).getDateTimeAccuracyCode());
                            ps.setString(9, discreteGroundWaterList.get(i).getDateTimeAccuracyText());
                            ps.setString(10, discreteGroundWaterList.get(i).getUncertainty());
                            ps.setString(11, discreteGroundWaterList.get(i).getMonitoringMethod());
                            ps.setString(12, discreteGroundWaterList.get(i).getMonitoringLocationIdentifier());
                        }
                        @Override
