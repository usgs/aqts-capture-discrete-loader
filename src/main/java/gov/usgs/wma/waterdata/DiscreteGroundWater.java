...
public class DiscreteGroundWater {
	...
	String remarks;
	String weather;
	String isValidHeaderInfo;
	String completedWork;
	Timestamp lastModified;
	String parameter;
	String parmCd;
	String monitoringMethod;
	String fieldVisitValue;
	String unit;
	String uncertainty;
	String readingType;
	String manufacturer;
	String model;
	String serialNumber;
	Timestamp fieldVisitTime;
	String fieldVisitComments;
	String publish;
	String isValidReadings;
	String referencePointUniqueId;
	String useLocationDatumAsReference;
	String readingQualifier;
	String readingQualifiers;
	String groundWaterMeasurement;
